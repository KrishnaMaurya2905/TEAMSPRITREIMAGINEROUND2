...
const Footer = () => {
  ...
  return (
    <div className="relative h-[85vh] max-md:h-[90vh]" style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}>
      <div className="fixed top-[13%] h-[100vh] w-full ">
        <div className="h-full absolute w-full flex flex-col gap-[2px]">
          <div className="w-full h-[100%] bg-transparent flex gap-[2px] max-md:flex-col text-white">
            <div className="left-part w-1/2 h-full max-md:h-1/2 max-md:w-full bg-[#000000b4] p-10 flex flex-col justify-between">
            ...
            <div className="right-part w-1/2 h-full max-md:h-1/2 max-md:w-full bg-[#000000b4]  flex flex-col">
              <div className="w-full h-[85%] uppercase text-[1.6vw] font-['Teko'] flex justify-between px-20 py-10">
                {FooterData.map((section, index) => (
                  <div key={index}>
                    <h1 className="text-[#7BBD42]">{section.title}</h1>
              ...
              <div className="h-[15%] font-['Teko'] w-full uppercase flex justify-between items-center px-10 text-[1.3vw]">
                <NavLinkAnimation>© Monster Energy Company</NavLinkAnimation>
